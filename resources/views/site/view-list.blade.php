                        ...
                        <div class="col-md-3">
                            ...
                            <div class="select-wrap">
                                ...
                                <select name="offer-types" id="offer-types" class="form-control d-block rounded-0">
                                    <option value="">For Esta sendo vendida</option>
                                    <option value="">For Esta sendo alugada</option>
                                    <option value="">For Em processamento</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                        <div class="mr-auto">
                            <a href="home" class="icon-view view-module"><span class="icon-view_module"></span></a>
                            <a href="view-list.html" class="icon-view view-list active"><span
                        ...
                        <div class="ml-auto d-flex align-items-center">
                            <div>
                                ...
                                <a href="#" class="view-list px-3 border-right">Esta sendo alugada</a>
                                <a href="#" class="view-list px-3">Esta sendo vendida</a>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="property-entry horizontal d-lg-flex">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem dolorem tenetur magni.
                                Aspernatur odit rem repudiandae cumque tenetur enim consequuntur esse.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                    <a href="#"><img src="{{asset('site/assets/images/img_4.jpg')}}" alt="Image" class="img-fluid"></a>
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                    <a href="#"><img src="{{asset('site/assets/images/img_2.jpg')}}" alt="Image" class="img-fluid"></a>
                    <div class="p-4 bg-white">
                        <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>
                        <h2 class="h5 text-black mb-3"><a href="#">Art Gossip by Mike Charles</a></h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias enim, ipsa exercitationem veniam
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="300">
                    <a href="#"><img src="{{asset('site/assets/images/img_3.jpg')}}" alt="Image" class="img-fluid"></a>
                    <div class="p-4 bg-white">
                        <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>
                        <h2 class="h5 text-black mb-3"><a href="#">Art Gossip by Mike Charles</a></h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias enim, ipsa exercitationem veniam
