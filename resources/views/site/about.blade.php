        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{asset('site/assets/images/about.jpg')}}" alt="Image" class="img-fluid">
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="team-member">
                        ...
                        <img src="{{asset('site/assets/images/person_1.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="300">
                    <div class="team-member">
                        ...
                        <img src="{{asset('site/assets/images/person_2.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="400">
                    <div class="team-member">
                        ...
                        <img src="{{asset('site/assets/images/person_3.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{asset('site/assets/images/person_4.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{asset('site/assets/images/person_5.jpg')}}" alt="Image" class="img-fluid rounded mb-4">
